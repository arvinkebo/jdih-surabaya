...
// Query untuk mengambil data Keputusan DPRD dengan pencarian
$query = "SELECT * FROM peraturan 
          WHERE tipe_dokumen = 'Keputusan DPRD' 
          AND status = 'Berlaku' 
          AND is_deleted = 0";
...
<head>
    ...
    <title>Keputusan DPRD Kota Surabaya</title>
    <link rel="stylesheet" href="../assets/css/dokumen-hukum/keputusan-dprd.css">
</head>
<body>
<?php include '../beranda/templates/header.php'; ?>
<main class="kep-dprd-container">
    <section class="page-header">
    <div class="container">
        <h1>Keputusan DPRD</h1>
        <div class="custom-breadcrumb">
            <span><a href="../beranda/home.php">Beranda</a></span>
            <span class="divider">/</span>
            <span><a href="#">Dokumen Hukum</a></span>
            <span class="divider">/</span>
            <span class="active">Keputusan DPRD</span>
        </div>
    </div>
    </section>
    <section class="search-section-keputusan-dprd">
        <div class="container">
            <div class="row">
                <!-- Konten Utama -->
                <div class="col-lg-8">
                    <div class="dokumen-hukum-search-and-controls">
                        <div class="dokumen-hukum-search-box-container">
                            <form action="keputusan-dprd.php" method="get" class="search-form" id="searchForm">
                        ...
                        <div class="pagination-controls-container">
                            <form action="keputusan-dprd.php" method="get" class="per-page-form" id="perPageForm">
                                ...
                                <?php if ($result->num_rows > 0): ?>
                                    ...
                                    <?php while ($row = $result->fetch_assoc()): ?>
                                        <tr>
                                            ...
                                            <td class="col-tipe"><?php echo htmlspecialchars($row['tipe_dokumen']); ?></td>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="6" style="text-align:center;">
                                            <?php echo empty($keyword) ? 'Tidak ada data Keputusan DPRD' : 'Data tidak ditemukan'; ?>
                                        </td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
