...
// Query untuk mengambil data Peraturan Daerah dengan pencarian
$query = "SELECT * FROM peraturan 
          WHERE tipe_dokumen = 'Peraturan Daerah' 
          AND status = 'Berlaku' 
          AND is_deleted = 0";
...
<head>
    ...
    <title>Peraturan Daerah Kota Surabaya</title>
    <link rel="stylesheet" href="../assets/css/dokumen-hukum/peraturan-daerah.css">
</head>
<body>
<?php include '../beranda/templates/header.php'; ?>
<main class="perda-container">
    ...
    <div class="container">
        ...
        <div class="custom-breadcrumb">
            ...
            <span class="divider">/</span>
            <span class="active">Peraturan Daerah</span>
        </div>
    </div>
    </section>
    <section class="search-section-perda">
        <div class="container">
            <div class="row">
                <!-- Konten Utama -->
                <div class="col-lg-8">
                    <div class="dokumen-hukum-search-and-controls">
                        <div class="dokumen-hukum-search-box-container">
                            <form action="peraturan-daerah.php" method="get" class="search-form" id="searchForm">
                        ...
                        <div class="pagination-controls-container">
                            <form action="peraturan-daerah.php" method="get" class="per-page-form" id="perPageForm">
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="6" style="text-align:center;">
                                            <?php echo empty($keyword) ? 'Tidak ada data Peraturan Daerah' : 'Data tidak ditemukan'; ?>
                                        </td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
