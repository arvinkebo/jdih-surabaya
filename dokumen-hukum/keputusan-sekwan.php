...
<main class="kep-sekwan-container">
    ...
    <div class="container">
        ...
        <div class="custom-breadcrumb">
            ...
            <span class="divider">/</span>
            <span class="active">Keputusan Sekretaris DPRD</span>
        </div>
    </div>
    </section>
    <section class="search-section-keputusan-sekwan">
        <div class="container">
            <div class="row">
                <!-- Konten Utama -->
                <div class="col-lg-8">
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="6" style="text-align:center;">
                                            <?php echo empty($keyword) ? 'Tidak ada data Keputusan Sekretaris DPRD' : 'Data tidak ditemukan'; ?>
                                        </td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
