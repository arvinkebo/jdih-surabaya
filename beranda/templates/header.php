...
<header class="main-header">
    <div class="header-container desktop-header">
        ...
        <div class="logo-container">
            <img src="../admin_dan_login/assets/images/logo-jdih.png" alt="Logo DPRD Surabaya" class="logo-img">
            <img src="../admin_dan_login/assets/images/logo_pemkot.png" alt="Logo DPRD Surabaya" class="logo-img">
            <img src="../admin_dan_login/assets/images/logo-dprd-surabaya.png" alt="Logo DPRD Surabaya" class="logo-img">
            <img src="../admin_dan_login/assets/images/text-jdih-dprd.png" alt="Logo DPRD Surabaya" class="logo-img">
            <!-- <div class="logo-text">
            ...
            <nav class="main-menu__nav">
                <ul class="nav-list">
                    ...
                    <li class="nav-item main-menu__nav_sub dropdown">
                        <a class="animation nav-padding dropdown-toggle" href="../beranda/home.php">
                            <i class="fas fa-home"></i> BERANDA
                        ...
                        <ul class="dropdown-menu main-menu__dropdown">
                            <li><a class="dropdown-item" href="../beranda/home.php#statistik-dokumen-hukum" data-section="statistik-dokumen-hukum"><i class="fas fa-chart-bar"></i> Statistik Dokumen Hukum</a></li>
                            <li><a class="dropdown-item" href="../beranda/home.php#cari-produk-hukum" data-section="cari-produk-hukum"><i class="fas fa-search"></i> Cari Produk Hukum</a></li>
                            <li><a class="dropdown-item" href="../beranda/home.php#portal-jdih" data-section="portal-jdih"><i class="fas fa-book"></i> Portal JDIH</a></li>
                            <li><a class="dropdown-item" href="../beranda/home.php#situs-terkait" data-section="situs-terkait"><i class="fas fa-external-link-alt"></i> Situs Terkait</a></li>
                        </ul>
                        <script>
                    ...
                    <li class="nav-item main-menu__nav_sub dropdown">
                        ...
                        <ul class="dropdown-menu main-menu__dropdown">
                            ...
                            <li><a class="dropdown-item" href="../profil/sejarah-jdihn.php"><i class="fa-solid fa-timeline"></i> Sejarah JDIHN</a></li>
                        </ul>
                    </li>
                ...
                <ul class="mobile-nav-list">
                    ...
                    <li class="mobile-nav-item mobile-dropdown">
                        ...
                        <ul class="mobile-dropdown-menu">
                            <li><a class="mobile-dropdown-item" href="#statistik-dokumen-hukum" data-section="statistik-dokumen-hukum"><i class="fas fa-chart-bar"></i> Statistik Dokumen Hukum</a></li>
                            <li><a class="mobile-dropdown-item" href="#cari-produk-hukum" data-section="cari-produk-hukum"><i class="fas fa-search"></i> Cari Produk Hukum</a></li>
                            <li><a class="mobile-dropdown-item" href="#portal-jdih" data-section="portal-jdih"><i class="fas fa-book"></i> Portal JDIH</a></li>
                            <li><a class="mobile-dropdown-item" href="#situs-terkait" data-section="situs-terkait"><i class="fas fa-external-link-alt"></i> Situs Terkait</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="mobile-nav-item mobile-dropdown">
                        ...
                        <ul class="mobile-dropdown-menu">
                            <li><a class="mobile-dropdown-item" href="../profil/dasar-hukum.php"><i class="fas fa-gavel"></i> Dasar Hukum JDIH</a></li>
                            <li><a class="mobile-dropdown-item" href="../profil/struktur-organisasi.php"><i class="fas fa-sitemap"></i> Struktur Organisasi</a></li>
                            <li><a class="mobile-dropdown-item" href="../profil/profil-dprd.php"><i class="fas fa-landmark"></i> Profil DPRD</a></li>
                            <li><a class="mobile-dropdown-item" href="../profil/sejarah-jdihn.php"><i class="fa-solid fa-timeline"></i> Sejarah JDIHN</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="mobile-nav-item mobile-dropdown">
                        ...
                        <ul class="mobile-dropdown-menu">
                            <li><a class="mobile-dropdown-item" href="../dokumen-hukum/peraturan-daerah.php"><i class="fas fa-gavel"></i> Peraturan Daerah</a></li>
                            <li><a class="mobile-dropdown-item" href="../dokumen-hukum/peraturan-dprd.php"><i class="fas fa-gavel"></i> Peraturan DPRD</a></li>
                            <li><a class="mobile-dropdown-item" href="../dokumen-hukum/keputusan-dprd.php"><i class="fas fa-balance-scale"></i> Keputusan DPRD</a></li>
                            <li><a class="mobile-dropdown-item" href="../dokumen-hukum/keputusan-sekwan.php"><i class="fas fa-scroll"></i> Kep. Sekretaris DPRD</a></li>
                        </ul>
                    </li>
